...
from data.cfdna_scaling import scaler_from_checkpoint
...
def main(args):
    ...
    # Load frozen preprocessing before constructing the evaluation cohort.
    ckpt = torch.load(args.model_path, map_location=device)
    scaler = scaler_from_checkpoint(ckpt, cfdna_dim)
    dataset = MultiModalDataset(args.test_data, args.labels_file,
                               target_shape=target_shape, cfdna_scaler=scaler)
